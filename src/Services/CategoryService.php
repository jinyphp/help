...
class CategoryService
{
    ...
    {
        $rules = [
            'code' => 'required|string|max:50|unique:help_categories,code',
        ...
        if ($id) {
            $rules['code'] = 'required|string|max:50|unique:help_categories,code,' . $id;
        }
