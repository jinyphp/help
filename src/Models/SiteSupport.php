...
class SiteSupport extends Model
{
    ...
    {
        return $this->hasMany(\Jiny\Help\Models\SiteSupportAssignment::class, 'support_id');
    }
    ...
    {
        return $this->hasOne(\Jiny\Help\Models\SiteSupportAssignment::class, 'support_id')->latest();
    }
    ...
    public function assignTo($userId, $assignedFrom = null, $note = null)
    {
        ...
        \Jiny\Help\Models\SiteSupportAssignment::createAssignment(
            $this->id,
            $userId,
            $assignedFrom,
            $action,
    ...
    public function unassign($unassignedBy = null, $note = null)
    {
        ...
        // 할당 해제 이력 생성
        if ($previousAssignee) {
            \Jiny\Help\Models\SiteSupportAssignment::create([
                'support_id' => $this->id,
    ...
    public function transferTo($newAssigneeId, $currentUserId, $note = null)
    {
        ...
        // 이전 이력 생성
        \Jiny\Help\Models\SiteSupportAssignment::createTransfer(
            $this->id,
            $currentUserId,
            $newAssigneeId,
            $note
    ...
    {
        $assignee = \Jiny\Help\Models\SiteSupportAutoAssignment::findAssigneeFor($this->type, $this->priority);
    ...
    {
        return $this->hasMany(\Jiny\Help\Models\SiteSupportReply::class, 'support_id');
    }
    ...
    {
        return $this->hasOne(\Jiny\Help\Models\SiteSupportReply::class, 'support_id')->latest();
    }
    ...
    {
        return $this->hasMany(\Jiny\Help\Models\SiteSupportMultipleAssignment::class, 'support_id');
    }
    ...
    {
        return $this->hasOne(\Jiny\Help\Models\SiteSupportMultipleAssignment::class, 'support_id')
            ->where('role', 'primary')
            ->where('is_active', true);
    }
    ...
    {
        return $this->hasMany(\Jiny\Help\Models\SiteSupportEvaluation::class, 'support_id');
    }
    ...
    public function reopen($note = null)
    {
        ...
        // 재오픈 이력 추가
        if ($note) {
            \Jiny\Help\Models\SiteSupportReply::createAdminReply(
                $this->id,
                auth()->id(),
                "지원 요청이 재오픈되었습니다.\n\n사유: " . $note,
                true // 내부 메모로 저장
    ...
    {
        return \Jiny\Help\Models\SiteSupportReply::createAdminReply(
            $this->id,
            auth()->id(),
            $content,
            $isPrivate,
    ...
    public function addCustomerReply($content, $userId = null, $attachments = null)
    {
        ...
        return \Jiny\Help\Models\SiteSupportReply::createCustomerReply(
            $this->id,
            $userId,
            $content,
            $attachments
    ...
    {
        return \Jiny\Help\Models\SiteSupportMultipleAssignment::assignAdmin(
            $this->id,
            $assigneeId,
            $role,
            auth()->id(),
