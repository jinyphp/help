...
namespace Jiny\Help\Http\Controllers\Site\Help\Support;
...
use Jiny\Help\Models\SiteSupportType;
...
class IndexController extends Controller
{
    ...
    {
        $this->config = [
            'view' => config('site.support.view', 'jiny-help::www.help.support.index'),
            'success_view' => config('site.support.success_view', 'jiny-help::www.help.support.success'),
