...
namespace Jiny\Help\Http\Controllers\Admin\Support\Statistics;

use Illuminate\Routing\Controller;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Auth;
use Illuminate\Support\Facades\DB;
use Jiny\Help\Models\SiteSupportEvaluation;
use App\Models\User;
...
class EvaluationStatsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('jiny-help::admin.support.statistics.evaluations', [
            'admin' => $admin,
            'stats' => $stats,
    ...
    public function ranking(Request $request)
    {
        ...
        return view('jiny-help::admin.support.statistics.ranking', [
            'rankings' => $rankings,
            'startDate' => $startDate,
            'endDate' => $endDate,
            'limit' => $limit,
