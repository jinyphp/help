...
use Jiny\Help\Models\SiteSupportAutoAssignment;
use App\Models\User;
...
class AutoAssignmentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('jiny-help::admin.support.auto-assignments.index', [
    ...
    public function create()
    {
        ...
        return view('jiny-help::admin.support.auto-assignments.create', [
            'admins' => $admins,
            'types' => $types,
        ]);
    }
    ...
    public function show($id)
    {
        ...
        return view('jiny-help::admin.support.auto-assignments.show', [
    ...
    public function edit($id)
    {
        ...
        return view('jiny-help::admin.support.auto-assignments.edit', [
            'autoAssignment' => $autoAssignment,
            'admins' => $admins,
            'types' => $types,
        ]);
