...
use Jiny\Help\Models\SiteSupportMultipleAssignment;
...
class EvaluationController extends Controller
{
    ...
    public function index(Request $request, $supportId)
    {
        try {
            ...
            return view('jiny-help::admin.support.evaluations.index', [
                'support' => $support,
    ...
    public function create($supportId)
    {
        try {
            ...
            return view('jiny-help::admin.support.evaluations.create', [
                'support' => $support,
